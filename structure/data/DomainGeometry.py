...
class DomainGeometry:
    ...
    def summary(self) -> str:
        lines = [
            ...
            "  DOMAIN GEOMETRY",
            "=" * 62,
            f"  Pre-calender box  : {self.Lx_nm / 1000:.1f} × {self.Ly_nm / 1000:.1f} × {self.Lz_pre_nm / 1000:.1f} µm",
            f"  Final box         : {self.Lx_nm / 1000:.1f} × {self.Ly_nm / 1000:.1f} × {self.Lz_final_nm / 1000:.1f} µm  (cubic)",
            ...
            "    Z = 0           : current collector",
            f"    Z = {self.Lz_final_nm / 1000:.1f} µm       : electrolyte interface",
            f"  Compression       : {self.compression_ratio:.2f}  ({self.Lz_pre_nm / 1000:.1f} µm → {self.Lz_final_nm / 1000:.1f} µm)",
